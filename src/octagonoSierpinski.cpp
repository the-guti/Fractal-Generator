...
OctagonoSierpinski::OctagonoSierpinski(){}


void OctagonoSierpinski::Render(sf::RenderWindow& window) //OBTIENE UN RENDERWINDOW
{   /*ESTA FUNCIÓN OBTIENE LOS PARÁMETROS PARA ENCONTRAR LAS DIMENSIONES DE LOS PUNTOS
    ...
    drawOctagonoSierpinski(p1, center, radius, angle_radians, increment_radians, -1, window);
}

void OctagonoSierpinski::drawOctagonoSierpinski(const sf::Vector2f &reference_point,
    ...
    else
    {
        ...
        {
            ang_actual = 90.00 * (M_PI/180);
            drawOctagonoSierpinski(point0_0, center0, radius_3, ang_actual, incremento_ang, iteration+1, window);
            drawOctagonoSierpinski(point0_1, center1, radius_3, ang_actual, incremento_ang, iteration+1, window);
            drawOctagonoSierpinski(point0_2, center2, radius_3, ang_actual, incremento_ang, iteration+1, window);
            drawOctagonoSierpinski(point0_3, center3, radius_3, ang_actual, incremento_ang, iteration+1, window);
            drawOctagonoSierpinski(point0_4, center4, radius_3, ang_actual, incremento_ang, iteration+1, window);
            drawOctagonoSierpinski(point0_5, center5, radius_3, ang_actual, incremento_ang, iteration+1, window);
            drawOctagonoSierpinski(point0_6, center6, radius_3, ang_actual, incremento_ang, iteration+1, window);
            drawOctagonoSierpinski(point0_7, center7, radius_3, ang_actual, incremento_ang, iteration+1, window);
        }
    }
...
void OctagonoSierpinski::setNumberOfIterations(int newNumberOfIterations)
{
    m_numberOfIterations = newNumberOfIterations; //DA EL NÚMERO DE ITERACIONES
}

int OctagonoSierpinski::getNumberOfIterations() const
{
    return m_numberOfIterations; //OBTIENE EL NÚMERO DE ITERACIONES ***** BUSCAR DONDE SE USA
}

void OctagonoSierpinski::setBoundingBox(float x1, float y1, float x2, float y2)
...
sf::RectangleShape OctagonoSierpinski::getBoundingBox() const
{
    return m_boundingBox;                   //REGRESA EL BOUNDING BOX
}

void OctagonoSierpinski::setColor(const sf::Color& newColor) //DA EL COLOR PRINCIPAL ** VER SI SE USA OTRA VEZ
{
    m_color = sf::Color(newColor);
}

sf::Color OctagonoSierpinski::getColor() const //OBTIENE EL COLOR *** VER DONDE SE USA
{
    return m_color;
}
